package io.github.mew22.becreative.core.ui.component
...
import io.github.mew22.becreative.core.ui.R
import io.github.mew22.becreative.core.ui.component.NavBar.Action
import io.github.mew22.becreative.core.ui.component.button.TextLinkBlue
import io.github.mew22.becreative.core.ui.designsystem.MainTheme
        ...
        title = {
            Column {
                ...
                if (title != null) {
                    ToolbarTitle(
                        text = title,
                        secondaryInfo?.let { MainTheme.typography.titleMedium }
                    )
                }
...
@Composable
private fun ToolbarAction(action: Action) {
    Box {
        when (action) {
            is Action.IconAction -> IconButton(onClick = action.onClick) {
                Icon(
                    painter = action.icon,
            ...
            is Action.TextAction -> TextLinkBlue(
                text = action.text,
...
private fun Navigation_Title() {
    NavBar(
        ...
        navigationAction = Action.IconAction(
            icon = painterResource(id = R.drawable.ic_back)
        )
    )
}
...
private fun Navigation_Title_TwoActions() {
    NavBar(
        ...
        secondAction = Action.IconAction(
            icon = painterResource(id = R.drawable.ic_close_black)
        ),
    )
}
