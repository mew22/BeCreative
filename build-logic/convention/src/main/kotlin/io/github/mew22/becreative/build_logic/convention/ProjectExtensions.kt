package io.github.mew22.becreative.build_logic.convention
...
val Project.myPackage
    get() = if (path.contains("app")) "io.github.mew22.becreative"
    else
        path.split(":").drop(1).joinToString(".").let { moduleName ->
            if (moduleName.isNotEmpty()) "io.github.mew22.becreative.$moduleName" else "io.github.mew22.becreative"
